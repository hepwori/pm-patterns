### **Pattern:** Algorithm–Product Gap

**Also Known As:** Model ≠ Product, The Interpretability Divide
...
* **Transparency as Trust Multiplier** — explanation converts opacity into confidence.
