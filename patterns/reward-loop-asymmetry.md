### **Pattern:** Reward Loop Asymmetry

**Also Known As:** Temporal Myopia, Short-Term Rationality
...
* [[perverse-correlation.md]] — when metric meaning inverts as it becomes a target.  
* [[dual-competence.md]] — navigating between craft quality and system fluency, including incentive literacy.  
* **Local Optimization** — rational behavior at subsystem level producing irrational system outcomes.  
* **Reward Visibility Bias** — privileging observable progress over latent value.
