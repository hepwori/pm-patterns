### **Pattern:** Ontology Leakage

**Also Known As:** Internal Model Projection
...
* **Proxy Empathy** — internal goals expressed in user language.  
* **Inverted Problem** — internal pain mistaken for external need.  
* [[dual-competence.md]] — navigating the trade-off between organizational fluency and craft.  
* **Interface Myopia** — when teams design the surface but ignore the underlying ontology.
